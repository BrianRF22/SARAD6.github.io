...
<body>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo "<b>".$d['directivo']."</b> ".$d['reg_directivo']; ?><input id="modificar_reg_directivo_<?php echo $d['id_reg']; ?>" value="<?php echo $d['reg_directivo']; ?>" type="hidden"></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group">
                            ...
                            <textarea id="modificar_reg_directivo" class="form-control" required="" name="reg_directivo"></textarea>
                        </div>
    ...
    <script>
        function modificar(id_reg){
            ...
            $("#modificar_reg_directivo").val($("#modificar_reg_directivo_" + id_reg).val());
